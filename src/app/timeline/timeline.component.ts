...
export class TimelineComponent implements OnInit {
  ...
  constructor(private migrateSer: MigrateService, private route: ActivatedRoute, private formBuilder: FormBuilder) { }


  ngOnInit(): void {

    if (this.route.snapshot.params['id']) {
      this.custonRangeDates();
    } else {
      this.onLoadDates();
    }

    // this.getTimeline();   To getch the data from api instead of static data
      ...
      [
        {
          ...
          "group_data": [
            ...
            {
              "mgroup_id": "MG1027",
              "group_start_date": "06-12-2021",
              "group_end_date": "07-12-2021",
              "status": "Error",
              "status_From_Date": "06-28-2021"
            }
          ]
        },
        {
          ...
          "group_data": [
            ...
            {
              "mgroup_id": "MG104",
              "group_start_date": "06-28-2021",
              "group_end_date": "07-28-2021",
              "status": "Running",
              "status_From_Date": null
            },
            {
        ...
        },
        {
          ...
          "group_data": [
            {
              "mgroup_id": "MG125",
              "group_start_date": "03-25-2021",
              "group_end_date": "05-19-2021",
              "status": "Running",
              "status_From_Date": null
            },
            {
              "mgroup_id": "MG115",
              "group_start_date": "05-05-2021",
              "group_end_date": "05-19-2021",
              "status": "Running",
              "status_From_Date": null
            },
  ...
  getProgressRunning(submg, d) {
    ...
    let subDifference_In_Time = currentDate.getTime() - startDate.getTime();
  ...
  checkProgressBeforeError(submg, d) {
    ...
    return ((subdifference_In_Days + 1) * 50) - 1;
  ...
  getStyle(task, d) {
    ...
    if ((endDate > toDate) && (startDate < fromDate)) {
      ...
      this.textAlignStyle = 'text-center';
      ...
      if ((endDate < toDate) && (startDate < fromDate)) {
        ...
        if ((endDate > toDate) && (startDate > fromDate)) {
          ...
          let subdifference_In_Days = subDifference_In_Time / (1000 * 3600 * 24);
          // console.log(subdifference_In_Days);
          this.textAlignStyle = 'text-right';
